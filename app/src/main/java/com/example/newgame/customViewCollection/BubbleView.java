...
public class BubbleView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        LinearGradient gradient = new LinearGradient(mWaterRectF.centerX(), mWaterRectF.top,
                mWaterRectF.centerX(), mWaterRectF.bottom, getResources().getColor(R.color.colorAccent), getResources().getColor(R.color.danhuangse), Shader.TileMode.CLAMP);

        Bitmap bitmap = BitmapFactory.decodeResource(this.getContext().getResources(), R.drawable.game_nav_background);

        BitmapShader bitmapShader = new BitmapShader(bitmap, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);

        mWaterPaint.setShader(bitmapShader);
    }
