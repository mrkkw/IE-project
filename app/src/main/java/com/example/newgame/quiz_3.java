...
public class quiz_3 extends AppCompatActivity {
    ...
    private game_machine_listAdapter recycleAdapter;
    ...
    private void setRecyclerView(){
        ...
        recyclerView = (RecyclerView)findViewById(R.id.game_machine_quiz_list);

        initData();

        recycleAdapter= new game_machine_listAdapter(quiz_3.this, mDatas,recyclerView);
    ...
    private void backBtn(){
        Button btn = (Button)findViewById(R.id.back_button_quiz3);
    ...
    public void showDialog() {
        ...
        textView.setText("Preventing children from lifting heavy items!");
    ...
    public void alertDialog() {
        ...
        btn_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alert11.dismiss();
                Intent intent = new Intent(quiz_3.this,gamepage.class);
